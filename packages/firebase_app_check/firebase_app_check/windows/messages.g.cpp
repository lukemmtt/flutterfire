...
bool CustomAppCheckToken::operator==(const CustomAppCheckToken& other) const {
  return PigeonInternalDeepEquals(token_, other.token_) && PigeonInternalDeepEquals(expire_time_millis_, other.expire_time_millis_);
}
...
size_t CustomAppCheckToken::Hash() const {
  size_t result = 1;
  result = result * 31 + PigeonInternalDeepHash(token_);
  result = result * 31 + PigeonInternalDeepHash(expire_time_millis_);
  return result;
}

size_t PigeonInternalDeepHash(const CustomAppCheckToken& v) {
  return v.Hash();
}
